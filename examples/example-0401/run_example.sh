...
#mkdir -p results/current_run/l1x1_n24x24_i2_s0_p1 && ./$folder/src/example 24 24 2 0 0.005 3.0 1 hodgkin_huxley_1952.cellml F 0.0001 && mv *.ex* results/current_run/l1x1_n24x24_i2_s0_p1
...
mkdir -p results/current_run/l1x1_n2x2_i1_s0_p1 && ./$folder/src/example 2 2 2 0 0.005 3.0 1 hodgkin_huxley_1952.cellml F 0.0001 && mv *.ex* results/current_run/l1x1_n2x2_i1_s0_p1
