...
gfx read nodes results/current_run/l4x2x0_n100x50x0_i1_s1/Example.part0.exnode
gfx read elements results/current_run/l4x2x0_n100x50x0_i1_s1//Example.part0.exelem
...
gfx modify g_element "/" node_points subgroup Region coordinate Geometry LOCAL glyph point general size "1*1*1" centre 0,0,0 font default select_on material black selected_material default_selected
...
gfx modify spectrum scalarfield_spectrum linear reverse range 0 25 extend_above extend_below rainbow colour_range 0 1 component 1;
...
gfx modify window 1 layout simple ortho_axes z -y eye_spacing 0.25 width 998 height 610
gfx modify window 1 set current_pane 1
gfx modify window 1 background colour 1 1 1 texture none
gfx modify window 1 view parallel eye_point 5.21171 -2.04006 1.77211 interest_point 1.61161 0.907899 -0.0488272 up_vector -0.293808 0.216312 0.931067 view_angle 52.263 near_clipping_plane 0.0499671 far_clipping_plane 17.8565 relative_viewport ndc_placement -1 1 2 2 viewport_coordinates 0 0 1 1
...
gfx print postscript file doc/figures/current_run_l4x2x0_n100x50x0_i1_s1.eps
