...
for $i (1..5)
  {
   $filename = sprintf("results/current_run/l160x120x000_n08x06x00_i1_s0/Example_%d.part0.exnode", $i);
	 #$filename = sprintf("results/current_run/l160x120x000_n08x06x00_i2_s0/Example_%d.part0.exnode", $i);
	 #$filename = sprintf("results/current_run/l160x120x000_n16x12x00_i2_s0/Example_%d.part0.exnode", $i);
...
#gfx read elements results/current_run/l160x120x000_n08x06x00_i2_s0/Example.part0.exelem;
#gfx read elements results/current_run/l160x120x000_n16x12x00_i2_s0/Example.part0.exelem;
