...
gfx read node results/current_run/3D_MeshRefinementLevel_002/Example.part0.exnode time 0
for ($i = 100 ; $i < 1001 ; $i=$i+100)
{
    $filename = sprintf("results/current_run/3D_MeshRefinementLevel_002/Example_%d.part0.exnode", $i);
