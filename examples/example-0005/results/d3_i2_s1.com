...
gfx read nodes results/current_run/d3_i2_s1/Example.part0.exnode
gfx read elements results/current_run/d3_i2_s1/Example.part0.exelem
...
gfx define tessellation finer_tessel minimum_divisions 100
...
gfx modify g_element "/" lines coordinate Geometry tessellation finer_tessel LOCAL select_on material black data ScalarField spectrum scalarfield_spectrum selected_material default_selected
...
gfx modify window 1 layout simple ortho_axes z -y eye_spacing 0.25 width 1225 height 902;
gfx modify window 1 set current_pane 1;
gfx modify window 1 background colour 1 1 1 texture none;
gfx modify window 1 view parallel eye_point 0.810803 0.952166 3.99034 interest_point 0.5 0.5 0.5 up_vector 0.000445342 0.991708 -0.128513 view_angle 40 near_clipping_plane 0.0353321 far_clipping_plane 12.6265 relative_viewport ndc_placement -1 1 2 2 viewport_coordinates 0 0 1 1;
...
gfx print postscript file doc/figures/current_run_d3_i2_s1.eps
