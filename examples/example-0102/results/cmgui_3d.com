...
for $i (1..5)
  {
	 $filename = sprintf("results/current_run/l160x120x120_n08x06x06_i1_s0/Example_%d.part0.exnode", $i);
...
gfx read elements results/current_run/l160x120x120_n08x06x06_i1_s0/Example.part0.exelem;
