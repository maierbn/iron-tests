...
\begin{itemize}
    ...
    \item{Commandline arguments for tests are:}
        ...
        \subitem{2.0 1.0 0.0 8 4 0 7 0}% linear simplex
        \subitem{2.0 1.0 0.0 8 4 0 8 0}% quadratic simplex
        ...
        \subitem{2.0 1.0 0.0 8 4 0 7 1}% linear simplex
        \subitem{2.0 1.0 0.0 8 4 0 8 1}% quadratic simplex
        ...
        \subitem{2.0 1.0 1.0 8 4 4 7 0}% linear simplex
        \subitem{2.0 1.0 1.0 8 4 4 8 0}% quadratic simplex
        ...
        \subitem{2.0 1.0 1.0 8 4 4 7 1}% linear simplex
        \subitem{2.0 1.0 1.0 8 4 4 8 1}% quadratic simplex
