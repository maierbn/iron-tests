...
# 2D Tests
#echo "    2D tests"
mkdir -p results/current_run/l160x120x000_n08x06x00_i1_s0 && ./$folder/src/example 160 120 0 8 6 0 1 0 10000 0.3 0.1
...
# 3D Tests
#echo "    3D tests"
#mkdir -p results/current_run/l160x120x120_n08x06x06_i1_s0 && ./$folder/src/example 160 120 120 8 6 6 1 0 10000 0.3 0.025
