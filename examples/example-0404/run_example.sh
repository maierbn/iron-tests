...
mkdir -p results/current_run/l1x1_n24x24_i1_s0 && ./$folder/src/example 24 1 0 0.05 3.0 1 hodgkin_huxley_1952.cellml F 0.001 && mv *.ex* results/current_run/l1x1_n24x24_i1_s0
